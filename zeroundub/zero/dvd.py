...
class CDDVD:
    ...
    def __init__(self, iso_path):
        ...
        self.files = {file_name.rsplit(';', 1)[0]: file_name
                      for file_name in next(self.iso9660_facade.walk('/'))[2]}
    ...
    def open(self, file_name):
        ...
        with self.iso9660_facade.open_file_from_iso(f'/{file_name}') as file_h:
            yield file_h
